...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'lostnfoundweb@gmail.com';
        $config['smtp_pass'] = 'aldi201100';
        ...
        $this->email->from('addin5th@gmail.com', 'Lost & Found');
        ...
        if ($type == 'verify') {
            ...
            href="' . base_url() . 'auth/verify?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '">Activated</a>');
        } else if ($type == 'forgot') {
